document.addEventListener("DOMContentLoaded", () => {
  ...
  $(".main-slider_carousel-block").slick({
    ...
    arrows: true,
    prevArrow:
      '<button type="button" class="main-slider_carousel-block slick-prev"><img src="./images/dist/icons/arrow-prev.svg" alt="arrow-prev" /></button>',
    nextArrow:
      '<button type="button" class="main-slider_carousel-block slick-next"><img src="./images/dist/icons/arrow-circle.svg" alt="arrow-next" /></button>',
    responsive: [
      {
        breakpoint: 526,
        settings: {
  ...
  $(".slider-slick__list").slick({
    ...
    centerPadding: "70px",
    prevArrow:
      '<button type="button" class="slider-slick__list slick-prev"><img src="./images/dist/icons/arrow-prev.svg" alt="arrow-prev" /></button>',
    nextArrow:
      '<button type="button" class="slider-slick__list slick-next"><img src="./images/dist/icons/arrow-circle.svg" alt="arrow-next" /></button>',
  });
});
